...
class DiagonalWordLocator(private val word: String, private val searchArea: Array<Array<String>>) : WordLocator {
    ...
    private fun isOutsideSearchArea(row: Int, column: Int): Boolean {
        return row >= searchArea.size
                || column >= searchArea.size
    }
}
